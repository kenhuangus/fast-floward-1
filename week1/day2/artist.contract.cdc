...
//W1Q3
//Create a Collection resource for our Artist contract that will 
//allow accounts to store their Picture resources once they're printed. 
//Take note, you can only create resources within a contract.
pub contract Artist {
    pub struct Canvas {
        pub let width: UInt8
